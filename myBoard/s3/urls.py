...
urlpatterns = [
    ...
    path('get-folder-by-bucket-id/', s3_folder_views.GetFolderByBucketId.as_view(), name='s3_folder'),
    path('s3-upload-single-data/', s3_views.S3UploadSingleImage.as_view(), name='s3_upload_single_data'),
]
